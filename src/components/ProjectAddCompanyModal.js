...
function ProjectAddCompanyModal(props) {
  const { show, setShow } = props
  const { addCompanyProject } = useContext(ProjectsContext)
  const allFields = ["Industry", "Commercial", "Education", "Healthy", "Entertainment", "culture"]

  return (
    <Modal show={show} onHide={() => setShow(false)}>
      <Form onSubmit={addCompanyProject}>
...
export default ProjectAddCompanyModal
